    ...
    while(continuar){
        ...
        switch(opcao){
            case 1:
                ...
                cin >> valor;
                if (arv->inserir(valor)) cout << endl << "\u2714 Valor inserido com sucesso." << endl;
                else cout << endl << "\u274C Erro ao inserir nodo" << endl;
            break;
            case 2:
                cout << "Digite o valor que deseja remover: ";
                cin >> valor;
                if (arv->remover(valor)) cout << endl <<"\u2714 Removido com sucesso." << endl;
                else cout << endl <<"\u274C Erro ao remover o nodo." << endl;
            break;
            case 3:
                cout << "Digite o valor que deseja buscar: ";
                cin >> valor;
                if(arv->buscar(valor)) cout << endl << "\u2714 " << valor << " encontrado com sucesso. " << endl;
                else cout << endl <<"\u274C " << valor << " não encontrado." << endl;
            break;
            case 4:
                cout << "Árvore Rubro Negra" << endl << "P: preto" << endl << "V: vermelho" << endl << endl;
                if (!arv->vazia()) arv->print_arvore();
